...
public class F15CFlightPlanClient extends ConnectedThingClient {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(F15CFlightPlanClient.class);
    ...
    public F15CFlightPlanClient(ClientConfigurator config) throws Exception {
        super(config);
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        F15CFlightPlanClient f15cClient = new F15CFlightPlanClient(config);
