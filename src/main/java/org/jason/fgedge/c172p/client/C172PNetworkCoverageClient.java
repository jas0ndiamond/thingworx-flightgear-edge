...
public class C172PNetworkCoverageClient extends ConnectedThingClient {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(C172PNetworkCoverageClient.class);
    ...
    public C172PNetworkCoverageClient(ClientConfigurator config) throws Exception {
        super(config);
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        C172PNetworkCoverageClient c172pClient = new C172PNetworkCoverageClient(config);
